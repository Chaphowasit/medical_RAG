...
class QdrantAdaptor:
    def __init__(self, collection_name):
        ...
        # Initialize the Thai2VecEmbedder, QdrantClient, and TextCleaner
    ...
    def add_documents_from_pdf(self, pdf_path: str, effective_date: str = None):
        ...
        # Split the documents into chunks and preprocess the text
    ...
    def create_file(self, file_path: str, effective_date: str = None):
        ...
        # Check if the file already exists in Qdrant metadata
